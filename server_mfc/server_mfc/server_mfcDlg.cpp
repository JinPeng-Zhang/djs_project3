...
CservermfcDlg::CservermfcDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SERVER_MFC_DIALOG, pParent)
	, port(0)
{
...
BEGIN_MESSAGE_MAP(CservermfcDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CservermfcDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CservermfcDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CservermfcDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
